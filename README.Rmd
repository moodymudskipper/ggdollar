...
`theme()` is a complex function, we provide nested lists of functions that should
guide the users to what they through a sequence of limited choices thanks to
autocomplete.
...
`ggset` lets you dig to the element you want to change,
  ...
  `theme(panel.background = element_rect(fill = "blue"))`. The arguments are
